...
namespace AppVendasWeb.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Search(string searchString)
        {
            ...
            return View("Index", await _context.Produtos.Where(c => c.ProdutoDescricao.Contains(searchString)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,ProdutoDescricao,Preco,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProdutoId,ProdutoDescricao,Preco,CategoriaId")] Produto produto)
        {
